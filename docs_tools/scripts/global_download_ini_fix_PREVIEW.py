...
argument_data =         "E:/Roberts Space Industries/StarCitizen/4.0_PREVIEW/Data.p4k"  # Path to the Data.p4k
build_manifest_path =   "E:/Roberts Space Industries/StarCitizen/4.0_PREVIEW/build_manifest.id"  # Path to the build_manifest.id file
...
def extract_build_number(manifest_path):
    try:
        ...
        if branch_match and change_num_match:
            ...
            return f"{branch} PREV.{change_num}"
        else:
